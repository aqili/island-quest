...
export const CHARACTER_REGISTRY = [
  ...
  // ── Kenney – Animated Characters 3 (CC0) ────────────────────────────────
  // GLB files generated by: scripts/convert_kenney.py (Blender 4.4 portable)
  {
    id:          "kn_humanMale",
    name:        "Adventurer",
    source:      "kenney",
    model:       "/public/assets/characters/kenney/humanMale.glb",
    thumbnail:   "🧑",
    description: "Human male adventurer (Kenney)",
    scale:       1.0,
    yOffset:     0.0,
    facingOffset: 0,
  ...
  },
  {
    ...
    name:        "Heroine",
    source:      "kenney",
    model:       "/public/assets/characters/kenney/humanFemale.glb",
    thumbnail:   "👩",
    description: "Human female heroine (Kenney)",
    scale:       1.0,
    yOffset:     0.0,
    facingOffset: 0,
    animations:  { idle: "idle", walk: "run", run: "run", jump: "jump" },
  ...
  },
  {
    ...
    name:        "Zombie",
    source:      "kenney",
    model:       "/public/assets/characters/kenney/zombieMale.glb",
    thumbnail:   "🧟",
    description: "Zombie male (Kenney)",
    scale:       1.0,
    yOffset:     0.0,
    facingOffset: 0,
    animations:  { idle: "idle", walk: "run", run: "run", jump: "jump" },
...
export const NPC_CHARACTERS = [
  { model: "/public/assets/characters/kenney/humanMale.glb",    scale: 0.012 },
  { model: "/public/assets/characters/kenney/humanFemale.glb",  scale: 0.012 },
  { model: "/public/assets/characters/kenney/zombieMale.glb",   scale: 0.012 },
  { model: "/public/assets/characters/kenney/zombieFemale.glb", scale: 0.012 },
];
